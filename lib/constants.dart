...
const Color kAppBarColor = Colors.black54;
...
const TextStyle kInfoPanelTS = TextStyle(
  fontSize: 20,
  fontWeight: FontWeight.w600,
);

const TextStyle kTitleRowTS = TextStyle(
  color: Colors.white,
  fontSize: 24.0,
...
const TextStyle kCountryTitle = TextStyle(
  color: Colors.black,
  fontSize: 22,
  letterSpacing: 2,
  fontWeight: FontWeight.w600,
...
const TextStyle kCountryCases = TextStyle(
